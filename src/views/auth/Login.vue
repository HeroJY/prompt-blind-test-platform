      ...
      <div class="auth-hero">
        <div>
          <div class="brand">
            ...
            <div>
              <h2>Prompt 盲测系统</h2>
              <p>我要验牌 · 高保真前端原型 · 仅模拟数据</p>
            </div>
          </div>
          <h1>像最终系统一样操作，
            直接预览真实页面节奏</h1>
          <p>这个原型不调用后端接口，但会模拟登录、prompt盲测、结果保存、任务发布、提前退出、统计归因等核心流程。页面布局和操作逻辑按最终产品思路设计，方便你确认 UI 和交互。</p>
          <div class="hero-grid">
            <div class="hero-card">
        ...
        <div>
          <div class="notice">建议你先分别体验“测试用户”和“管理员”两个角色。测试用户可以直接走完整答题流程；管理员可以体验新建任务、添加题目、模拟导入、发布任务和查看统计。</div>
      ...
      <div class="auth-panel">
        <div class="auth-card">
          ...
          <div class="card pad-lg">
            ...
            <div class="auth-tip" id="authTip">{{ authRole === 'tester' ? '模拟账号：tester01 / 123456。进入后可直接开始题目盲测，答案选择将按真实 Prompt 映射统计。' : '模拟账号：admin01 / 123456。进入后可创建任务、配置题目、发布任务并查看统计。' }}</div>
          </div>
        </div>
      </div>
    </div>
